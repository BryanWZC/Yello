...
async function addBoard(){
    ...
    const sampleCard = await Card.create({ title: 'test card', listIds: [ sampleListItem._id ]});
    const sampleBoard = await Board.create({ title: 'test board', cardIds: [sampleCard._id] });
